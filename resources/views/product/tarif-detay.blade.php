        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-xs-12">
                  ...
                  <table class="table">
                      <thead>
                      @foreach($urunTarifi as $urun)
                      <tr>
                          <td> <h4> {{$urun->tarifadi}} </h4>  </td>
                          <td width="100px;">Kaç Kişilik</td>
                          <td><center> Malzemeler</center></td>
                      </tr>
                      </thead>
                      <tbody>

                      <tr>
                          <td> <img src="{{asset('/uploads/products/').'/'.$urun->photo}}" height="400" width="650"> </td>
                          <td><br> <center> {{$urun->kackisi}}</center> </td>
                          <td> <br>  {{$urun->malzemeler}} </td>

                      </tr>
                      </tbody>

                  </table>
                    <p> {{$urun->hazirlanisi}}</p>
                </div>
                @endforeach
            </div>
        </div>
                        ...
                        <div class="single-footer-caption mb-50">
                            <div class="single-footer-caption mb-30">
                                ...
                                <div class="footer-logo">
                                    <a href="/"><img src="{{asset('assets/img/logo/loder.png')}}" alt=""
                                                     width="175"></a>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="footer-tittle">
                                ...
                                <ul>
                                    <li class="app-log"><a href="#"><img
                                                src="{{asset('assets/img/gallery/app-logo.png')}}" alt=""></a></li>
                                    <li><a href="#"><img src="{{asset('assets/img/gallery/app-logo2.png')}}" alt=""></a>
                                    </li>
                                </ul>
                            </div>
                        </div>
